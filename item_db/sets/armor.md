...
* **Properties:**
    ...
    * +15 to Dexterity
    * Lightning Resist +20%
    * 12-1% Chance to cast level 12-1 %s when struck
...
* **Properties:**
    * +400 Defense
    * 20-5% Chance to cast level 20-5 %s when struck
...
* **Properties:**
    * 10-3% Chance to cast level 10-3 %s when struck
    * Requirements -30%
...
* **Properties:**
    * +305-415 Defense
    * Lightning Resist +50%
    * 25-20% Chance to cast level 25-20 %s when struck
    * +1-2 to All Skills
    * +20% Faster Cast Rate
...
* **Properties:**
    ...
    * Poison Resist +60%
    * +175 to Life
    * 10-7% Chance to cast level 10-7 %s when struck
...
* **Properties:**
    ...
    * +100 to Life
    * 100-20% Chance to cast level 100-20 %s when struck
    * +20% Faster Run/Walk
    * Physical Damage Received Reduced by 10%
