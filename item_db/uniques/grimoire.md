...
* **Properties:**
    ...
    * 15-1% Chance to cast level %d %s when struck
    * +30%% Faster Cast Rate
...
* **Properties:**
    ...
    * +80-150 to Life
    * Physical Damage Received Reduced by 5-15%
    * 10-25% Better Chance of Getting Magic Items
...
* **Properties:**
    * +2 to Amazon Skill Levels
    * 15-40% Chance to cast level %d %s when struck
...
* **Properties:**
    ...
    * 30-25% Chance to cast level %d %s when struck
