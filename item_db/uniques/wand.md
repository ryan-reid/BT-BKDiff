...
* **Properties:**
    ...
    * 15-40% Chance to cast level 15-40 %s when struck
    * + to Mana (Based on Character Level)
    * 15-30% Chance to cast level 15-30 %s when struck
    * +30% Faster Cast Rate
...
* **Level Requirement:** 79
* **Properties:**
    * Level 6-9 431 Aura When Equipped
    * +2-4 to Magic Skills
...
* **Properties:**
    * Level 1-12 431 Aura When Equipped
    * +1-2 to All Skills
