...
* **Properties:**
    * 40% Chance to cast Level 20 92 on striking
...
* **Properties:**
    ...
    * +20 to Strength
    * Freezes target
    * 50% Chance to cast Level 17 64 on striking
    * : 150-200 (param: )
    * +20%% Increased Attack Speed
...
* **Properties:**
    * 50% Chance to cast Level 25 121 on striking
...
* **Properties:**
    * 50-35% Chance to cast level %d %s on attack
    * Ignore Target's Defense
    * Lightning Absorb +25%%
    * +40%% Increased Attack Speed
    * +1 to Holy Shock
...
* **Properties:**
    ...
    * +40%% Increased Attack Speed
    * 10-60% Chance to cast level %d %s when struck
...
* **Properties:**
    ...
    * +20%% Increased Attack Speed
    * Level 7 Redemption Aura When Equipped
...
* **Properties:**
    ...
    * +2 to All Skills
    * +25 Cold Absorb
    * 40% Chance to cast level %d %s on attack
...
* **Properties:**
    * : 170-240 (param: )
    * 100-60% Chance to cast level %d %s when you Kill an Enemy
    * +1-3 to Fire Skills
    * Fire Absorb +20-30%%
    * 20-60% Chance to cast level %d %s on attack
    * +1 to Fire Mastery
    * +15-20 to Strength
    * +12 to Inferno
    * +30%% Increased Attack Speed
...
* **Properties:**
    ...
    * +25%% Increased Attack Speed
    * Cold Absorb +7-15%%
    * 25-10% Chance to cast level %d %s on attack
    * 25-30% Chance to cast level %d %s on attack
...
* **Properties:**
    ...
    * -15-30% to Enemy Physical Damage Resistance
