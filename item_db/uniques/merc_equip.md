...
* **Properties:**
    * 100-250% Extra Gold from Monsters
    * 35-60% Better Chance of Getting Magic Items
    * Cannot Be Frozen
    * +1 to All Skills
...
* **Properties:**
    ...
    * Cannot Be Frozen
    * 5% Mana stolen per hit
    * 33-30% Chance to cast level 33-30 %s when struck
    * +5 to 264
    * Fire Resist +20-40%
...
* **Properties:**
    ...
    * 150-190% Extra Gold from Monsters
    * +20% Faster Run/Walk
...
* **Properties:**
    ...
    * +20% Increased Attack Speed
    * +25-30 to Strength
    * 15% Chance to cast level 15 %s when struck
    * +3 to 278
...
### Corrupted Harlequin Crest (Corrupted Harlequin Crest)
* **Base Item:** Shako
* **Level Requirement:** 62
* **Properties:**
    * : 1 (param: )
...
### Corrupted Valkyrie Wing (Corrupted Valkyrie Wing)
* **Base Item:** Winged Helm
* **Level Requirement:** 44
* **Properties:**
    * +30% Faster Run/Walk
...
* **Properties:**
    * Level 1-5 431 Aura When Equipped
    * +2 to All Skills
