...
* **Properties:**
    ...
    * 75-30% Chance to cast level 75-30 %s when struck
...
* **Properties:**
    ...
    * 50-40% Chance to cast level 50-40 %s when struck
    * 33-63% Chance to cast level 33-63 %s when struck
...
* **Properties:**
    ...
    * 25% Increased Chance of Blocking
    * +50 to Vitality
    * Physical Damage Received Reduced by 25%
...
* **Properties:**
    ...
    * Slows Target by 40%
    * 33-20% Chance to cast level 33-20 %s when struck
    ...
    * 33-40% Chance to cast level 33-40 %s when struck
...
* **Properties:**
    ...
    * 35-8% Chance to cast level 35-8 %s when struck
    * Requirements -30%
    * +0-7 to Amazon Skill Levels
    * +25% Faster Cast Rate
