...
## Removed Rows (35)
- 1 diamond \(any\) \+ 1 kris \+ 1 staff \+ 1 belt \-> savage polearm
- 1 key of terror \+ 1 key of hate \+ 1 key of destruction \-> portal to matron's den/forgotten sands/furnace of pain \(random\)
- 1 magic ring \+ 1 perfect ruby \+ 1 exploding potion \-> garnet ring
- 1 magic ring \+ 1 perfect sapphire \+ 1 thawing potion \-> cobalt ring
- 1 magic ring \+ 1 perfect topaz \+ 1 rejuvenation potion \-> coral ring
...
- 2 gul runes \+ 1 standard ruby \-> vex rune
...
- 2 um runes \+ 1 standard topaz \-> mal rune
...
- 3 perfect skull \+ 1 rare item \+ 1 stone of jordan \-> add 1 socket to rare item
- 3 shael runes \+ 1 chipped ruby \-> dol rune
- 3 sol runes \+ 1 chipped sapphire \-> shael rune
- 3 thul runes \+ 1 chipped topaz \-> amn rune
- 4 healing potions \(any\) \+ 1 standard ruby \+ 1 magic sword \-> sword of the leech
...
- `enabled`: <del><code>1</code></del> (Old) &rarr; <ins><code>0</code></ins> (New)
...
- `enabled`: <del><code>0</code></del> (Old) &rarr; <ins><code>1</code></ins> (New)
...
- `lvl`: <del><code>69</code></del> (Old) &rarr; <ins><code>(removed)</code></ins> (New)
- `ilvl`:  (Old) &rarr; <ins><code>69</code></ins> (New)
...
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>2</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>40</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
### 1 magic amulet \+ 1 jewel \+ 1 thul rune \+ 1 perfect emerald \-> safety amulet
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ac%</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>20</code></ins> (New)
### 1 magic amulet \+ 1 jewel \+ thul rune \+ 1 perfect sapphire \-> hit power amulet
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>att</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>200</code></ins> (New)
- `mod 2 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>250</code></ins> (New)
- `mod 3`: <del><code>howl</code></del> (Old) &rarr; <ins><code>balance1</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>15</code></ins> (New)
- `mod 3 max`: <del><code>15</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
### 1 magic axe \+ 1 jewel \+ ort rune \+ 1 perfect ruby \-> blood weapon
- `input 1`: <del><code>"axe</code></del><code>,mag</code><del><code>"</code></del> (Old) &rarr; <ins><code>weap</code></ins><code>,mag</code><ins><code>,eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>6</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>40</code></ins> (New)
- `mod 3 min`: <del><code>35</code></del> (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 3 max`: <del><code>60</code></del> (Old) &rarr; <ins><code>80</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic belt \+ 1 jewel \+ 1 tal rune \+ 1 perfect ruby \-> blood belt
- `input 1`: <del><code>"mbl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>belt</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>2</code></ins> (New)
- `mod 1 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>4</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>40</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>15</code></ins> (New)
- `mod 3 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic blunt weapon \+ 1 jewel \+ 1 tir rune \+ 1 perfect sapphire \-> hit power weapon
- `input 1`: <del><code>"blun</code></del><code>,mag</code><del><code>"</code></del> (Old) &rarr; <ins><code>weap</code></ins><code>,mag</code><ins><code>,eth</code></ins> (New)
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>reduce-ac</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>15</code></ins> (New)
- `mod 2 max`: <del><code>7</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3 min`: <del><code>35</code></del> (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 3 max`: <del><code>60</code></del> (Old) &rarr; <ins><code>80</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
...
- `input 1`: <del><code>"lbt</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>boot</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 3 min`: <del><code>2</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3 max`: <del><code>5</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic breast plate \+ 1 jewel \+ 1 eth rune \+ 1 perfect emerald \-> safety body
- `input 1`: <del><code>"brs</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>tors</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1`: <code>red-dmg</code> (Old) &rarr; <code>red-dmg</code><ins><code>%</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 2`: <del><code>red-mag</code></del> (Old) &rarr; <ins><code>ac</code></ins> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>25</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 4 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 4 max`: <del><code>30</code></del> (Old) &rarr; <ins><code>60</code></ins> (New)
- `mod 5`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 5 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 5 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 5 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic chain boots \+ 1 jewel \+ 1 ral rune \+ 1 perfect sapphire \-> hit power boots
- `input 1`: <del><code>"mbt</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>boot</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>balance1</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 2 max`: <del><code>7</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 3`: <del><code>ac-hth</code></del> (Old) &rarr; <ins><code>dex</code></ins> (New)
- `mod 3 min`: <del><code>25</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 3 max`: <del><code>60</code></del> (Old) &rarr; <ins><code>15</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic chain gloves \+ 1 jewel \+ 1 ort rune \+ 1 perfect sapphire \-> hit power gloves
- `input 1`: <del><code>"mgl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>glov</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>reduce-ac</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>15</code></ins> (New)
- `mod 2 max`: <del><code>7</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
...
- `input 1`: <del><code>"crn</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>helm</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
...
- `input 1`: <del><code>"fld</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>tors</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>dmg%</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>35</code></ins> (New)
- `mod 2 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>60</code></ins> (New)
- `mod 3 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 3 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>40</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic full helm \+ 1 jewel \+ 1 ith rune \+ 1 perfect sapphire \-> hit power helm
- `input 1`: <del><code>"fhl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>helm</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>balance1</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 2 max`: <del><code>7</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3`: <del><code>ac-miss</code></del> (Old) &rarr; <ins><code>att</code></ins> (New)
- `mod 3 min`: <del><code>25</code></del> (Old) &rarr; <ins><code>150</code></ins> (New)
- `mod 3 max`: <del><code>50</code></del> (Old) &rarr; <ins><code>200</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic gauntlets \+ 1 jewel \+ 1 ral rune \+ 1 perfect emerald \-> safety gloves
- `input 1`: <del><code>"hgl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>glov</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
...
- `input 1`: <del><code>"gts</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>shld</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>block1</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 2 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
...
- `input 1`: <del><code>"tbl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>belt</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>balance1</code></ins> (New)
- `mod 2 min`: <del><code>3</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 2 max`: <del><code>7</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
...
- `input 1`: <del><code>"vgl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>glov</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>2</code></ins> (New)
- `mod 1 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>4</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>40</code></ins> (New)
...
- `input 1`: <del><code>"hlm</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>helm</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>2</code></ins> (New)
- `mod 1 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>4</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>40</code></ins> (New)
...
- `input 1`: <del><code>"kit</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>shld</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1`: <code>red-dmg</code> (Old) &rarr; <code>red-dmg</code><ins><code>%</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 2`: <del><code>red</code></del><code>-mag</code> (Old) &rarr; <ins><code>res</code></ins><code>-mag</code> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3`: <del><code>res-mag</code></del> (Old) &rarr; <ins><code>ac%</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 3 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>60</code></ins> (New)
- `mod 4`: <del><code>ac%</code></del> (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`: <del><code>30</code></del> (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic leather gloves \+ 1 jewel \+ ort rune \+ 1 perfect amethyst \-> caster gloves
- `input 1`: <del><code>"lgl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>glov</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1`: <del><code>regen</code></del><code>-</code><del><code>mana</code></del> (Old) &rarr; <ins><code>mana</code></ins><code>-</code><ins><code>kill</code></ins> (New)
- `mod 1 min`: <del><code>4</code></del> (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 1 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 3`: <del><code>mana-kill</code></del> (Old) &rarr; <ins><code>cast1</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 3 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic light belt \+ 1 jewel \+ ith rune \+ 1 perfect amethyst \-> caster belt
- `input 1`: <del><code>"vbl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>belt</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
...
- `input 1`: <del><code>"ltp</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>tors</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1`: <del><code>regen-mana</code></del> (Old) &rarr; <ins><code>cast1</code></ins> (New)
- `mod 1 min`: <del><code>4</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 1 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>8</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic light plated boots \+ 1 jewel \+ 1 eth rune \+ 1 perfect ruby \-> blood boots
- `input 1`: <del><code>"tbt</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>boot</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>2</code></ins> (New)
- `mod 1 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>4</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>40</code></ins> (New)
- `mod 3`: <del><code>regen</code></del> (Old) &rarr; <ins><code>heal-kill</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 3 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>6</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic mask \+ 1 jewel \+ nef rune \+ 1 perfect amethyst \-> caster helm
- `input 1`: <del><code>"msk</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>helm</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 3`: <del><code>manasteal</code></del> (Old) &rarr; <ins><code>cast1</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 3 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic plate mail \+ 1 jewel \+ 1 thul rune \+ 1 perfect ruby \-> blood body
- `input 1`: <del><code>"plt</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>tors</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>6</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>60</code></ins> (New)
- `mod 3`: <del><code>demon</code></del><code>-</code><del><code>heal</code></del> (Old) &rarr; <ins><code>heal</code></ins><code>-</code><ins><code>kill</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 3 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>6</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic plated boots \+ 1 jewel \+ 1 ort rune \+ 1 perfect emerald \-> safety boots
- `input 1`: <del><code>"hbt</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>boot</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
...
- `mod 1`: <del><code>regen</code></del><code>-</code><del><code>mana</code></del> (Old) &rarr; <ins><code>mana</code></ins><code>-</code><ins><code>kill</code></ins> (New)
- `mod 1 min`: <del><code>4</code></del> (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 1 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>2</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3 max`: <del><code>5</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
...
- `mod 2`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>dmg-max</code></ins> (New)
- `mod 2 max`: <del><code>6</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3 max`: <del><code>5</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
...
- `input 1`: <del><code>"rod</code></del><code>,mag</code><del><code>"</code></del> (Old) &rarr; <ins><code>weap</code></ins><code>,mag</code><ins><code>,eth</code></ins> (New)
- `mod 1`: <del><code>regen-mana</code></del> (Old) &rarr; <ins><code>allskills</code></ins> (New)
- `mod 1 min`: <del><code>4</code></del> (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 1 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 3`: <del><code>mana%</code></del> (Old) &rarr; <ins><code>cast1</code></ins> (New)
- `mod 3 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 3 max`: <del><code>5</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic sash \+ 1 jewel \+ 1 tal rune \+ 1 perfect emerald \-> safety belt
- `input 1`: <del><code>"lbl</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>belt</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3`: <code>res-pois</code> (Old) &rarr; <code>res-pois</code><ins><code>-len</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>75</code></ins> (New)
- `mod 3 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 5`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 5 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 5 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 5 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
...
- `input 1`: <del><code>"sml</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>shld</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1`: <del><code>regen-mana</code></del> (Old) &rarr; <ins><code>cast1</code></ins> (New)
- `mod 1 min`: <del><code>4</code></del> (Old) &rarr; <ins><code>15</code></ins> (New)
- `mod 1 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>15</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 5`:  (Old) &rarr; <ins><code>allskills</code></ins> (New)
- `mod 5 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 5 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 5 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic spear \+ 1 jewel \+ 1 sol rune \+ 1 perfect emerald \-> safety weapon
- `input 1`: <del><code>"spea</code></del><code>,mag</code><del><code>"</code></del> (Old) &rarr; <ins><code>weap</code></ins><code>,mag</code><ins><code>,eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>4</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 2 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 2 max`: <del><code>2</code></del> (Old) &rarr; <ins><code>5</code></ins> (New)
- `mod 3`: <del><code>ac%</code></del> (Old) &rarr; <ins><code>swing3</code></ins> (New)
- `mod 3 min`: <del><code>5</code></del> (Old) &rarr; <ins><code>10</code></ins> (New)
- `mod 3 max`: <del><code>10</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>dmg%</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>30</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 5`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 5 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 5 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 5 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
### 1 magic spiked shield \+ 1 jewel \+ 1 ith rune \+ 1 perfect ruby \-> blood shield
- `input 1`: <del><code>"spk</code></del><code>,mag,</code><del><code>upg"</code></del> (Old) &rarr; <ins><code>shld</code></ins><code>,mag,</code><ins><code>eth</code></ins> (New)
- `mod 1 min`: <del><code>1</code></del> (Old) &rarr; <ins><code>3</code></ins> (New)
- `mod 1 max`: <del><code>3</code></del> (Old) &rarr; <ins><code>6</code></ins> (New)
- `mod 2 min`: <del><code>10</code></del> (Old) &rarr; <ins><code>50</code></ins> (New)
- `mod 2 max`: <del><code>20</code></del> (Old) &rarr; <ins><code>60</code></ins> (New)
- `mod 3`: <del><code>thorns</code></del> (Old) &rarr; <ins><code>block</code></ins> (New)
- `mod 3 min`: <del><code>4</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 3 max`: <del><code>7</code></del> (Old) &rarr; <ins><code>20</code></ins> (New)
- `mod 4`:  (Old) &rarr; <ins><code>ethereal</code></ins> (New)
- `mod 4 chance`:  (Old) &rarr; <ins><code>100</code></ins> (New)
- `mod 4 min`:  (Old) &rarr; <ins><code>1</code></ins> (New)
- `mod 4 max`:  (Old) &rarr; <ins><code>1</code></ins> (New)
...
- `output`: <code>"useitem,rep,rch,qty=</code><del><code>255</code></del><code>"</code> (Old) &rarr; <code>"useitem,rep,rch,qty=</code><ins><code>500</code></ins><code>"</code> (New)
### 1 ort rune \+ 1 weapon \-> fully repaired weapon
- `output`: <code>"useitem,rep,</code><code>qty=</code><del><code>255</code></del><code>"</code> (Old) &rarr; <code>"useitem,rep,</code><ins><code>rch,</code></ins><code>qty=</code><ins><code>500</code></ins><code>"</code> (New)
...
- `version`: <del><code>0</code></del> (Old) &rarr; <ins><code>100</code></ins> (New)
