...
### act 1 - graveyard
- `mon3`: $\color{gray}{\text{reanimatedhorde5}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `nmon3`: $\color{gray}{\text{reanimatedhorde5}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon3`: $\color{gray}{\text{reanimatedhorde5}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
...
- `mon1`: $\\color{gray}{\\text{crarcher4}}$ (Old) &rarr; $\\color{blue}{\\text{bloodlord3}}$ (New)
- `mon2`: $\\color{gray}{\\text{fingermage1}}$ (Old) &rarr; $\\color{blue}{\\text{imp2}}$ (New)
- `mon3`: $\color{gray}{\text{fetish3}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon4`: $\color{gray}{\text{reanimatedhorde6}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon5`: $\color{gray}{\text{imp4}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon6`: $\color{gray}{\text{megademon3}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon7`: $\color{gray}{\text{fallen8}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon8`: $\color{gray}{\text{fetishblow3}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon9`: $\color{gray}{\text{cr\\_lancer4}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon10`: $\color{gray}{\text{doomknight2}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `nmon1`: $\\color{gray}{\\text{crarcher8}}$ (Old) &rarr; $\\color{blue}{\\text{bloodlord3}}$ (New)
...
- `nmon7`: $\\color{gray}{\\text{fallen8}}$ (Old) &rarr; $\\color{blue}{\\text{skarcher10}}$ (New)
- `nmon8`: $\\color{gray}{\\text{fetishblow8}}$ (Old) &rarr; $\\color{blue}{\\text{bonefetish6}}$ (New)
- `nmon9`: $\\color{gray}{\\text{crlancer9}}$ (Old) &rarr; $\\color{blue}{\\text{fingermage4}}$ (New)
- `nmon10`: $\\color{gray}{\\text{doomknight2}}$ (Old) &rarr; $\\color{blue}{\\text{minion10}}$ (New)
- `umon1`: $\\color{gray}{\\text{crarcher8}}$ (Old) &rarr; $\\color{blue}{\\text{overseer2}}$ (New)
- `umon2`: $\\color{gray}{\\text{fingermage2}}$ (Old) &rarr; $\\color{blue}{\\text{bloodlord4}}$ (New)
- `umon3`: $\color{gray}{\text{fetish8}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon4`: $\color{gray}{\text{reanimatedhorde6}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon5`: $\color{gray}{\text{imp4}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon6`: $\color{gray}{\text{megademon3}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon7`: $\color{gray}{\text{fallen8}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon8`: $\color{gray}{\text{fetishblow8}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon9`: $\color{gray}{\text{cr\\_lancer9}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon10`: $\color{gray}{\text{doomknight2}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)

### act 5 - hell 2
- `NumMon`: $\\color{gray}{\\text{5}}$ (Old) &rarr; $\\color{blue}{\\text{3}}$ (New)
- `mon1`: $\\color{gray}{\\text{crarcher4}}$ (Old) &rarr; $\\color{blue}{\\text{bloodlord2}}$ (New)
...
- `nmon8`: $\\color{gray}{\\text{fetishblow8}}$ (Old) &rarr; $\\color{blue}{\\text{skmagefire6}}$ (New)
- `nmon9`: $\\color{gray}{\\text{crlancer9}}$ (Old) &rarr; $\\color{blue}{\\text{goatman8}}$ (New)
- `nmon10`: $\\color{gray}{\\text{doomknight2}}$ (Old) &rarr; $\\color{blue}{\\text{regurgitator4}}$ (New)
- `umon1`: $\\color{gray}{\\text{crarcher8}}$ (Old) &rarr; $\\color{blue}{\\text{overseer3}}$ (New)
- `umon2`: $\\color{gray}{\\text{fingermage2}}$ (Old) &rarr; $\\color{blue}{\\text{bloodlord4}}$ (New)
- `umon3`: $\color{gray}{\text{fetish8}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon4`: $\color{gray}{\text{reanimatedhorde6}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon5`: $\color{gray}{\text{imp4}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
...
### act 5 - hell 3
- `NumMon`: $\\color{gray}{\\text{5}}$ (Old) &rarr; $\\color{blue}{\\text{3}}$ (New)
- `mon1`: $\\color{gray}{\\text{crarcher}}\\text{4}$ (Old) &rarr; $\\color{blue}{\\text{imp}}\\text{4}$ (New)
...
- `mon9`: $\color{gray}{\text{cr\\_lancer4}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `mon10`: $\color{gray}{\text{doomknight2}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `nmon1`: $\\color{gray}{\\text{crarcher8}}$ (Old) &rarr; $\\color{blue}{\\text{imp7}}$ (New)
...
- `nmon8`: $\\text{fetishblow}\\color{gray}{\\text{8}}$ (Old) &rarr; $\\text{fetishblow}\\color{blue}{\\text{7}}$ (New)
- `nmon9`: $\\color{gray}{\\text{crlancer9}}$ (Old) &rarr; $\\color{blue}{\\text{reanimatedhorde6}}$ (New)
- `nmon10`: $\\color{gray}{\\text{doomknight2}}$ (Old) &rarr; $\\color{blue}{\\text{dkmag1}}$ (New)
- `umon1`: $\\color{gray}{\\text{crarcher8}}$ (Old) &rarr; $\\color{blue}{\\text{overseer4}}$ (New)
...
- `NumMon`: $\color{gray}{\text{3}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `nmon1`: $\color{gray}{\text{megademon5}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
- `umon1`: $\color{gray}{\text{megademon5}}$ (Old) &rarr; $\color{blue}{\text{(removed)}}$ (New)
