...
* **Properties:**
    ...
    * 75-30% Chance to cast level # Blizzard when struck
    * 50-40% Chance to cast level # Twister when struck
    * +60% Faster Run/Walk
    * +25 to Vitality
...
* **Properties:**
    ...
    * 50% Chance to cast level # Frost Nova when struck
    * 50-40% Chance to cast level # Nova when struck
    * 33-63% Chance to cast level # Hydra when struck
    * Durability: 40 of #
...
* **Properties:**
    * 25-30% Chance to cast level # Poison Nova when you Kill an Enemy
    * Poison Resist +75%
...
* **Properties:**
    ...
    * Slows Target by 40%
    * 33-20% Chance to cast level # Decrepify when struck
    * 5-9% Life stolen per hit
    * 100-44% Chance to cast level # Nova when you Die
    * Cold Resist +40-80%
    * Requirements --30%
    * Damage Reduced by 20-30%
    * +1 to All Skills
    * +2 to Random Class Skill Levels
    * 33-40% Chance to cast level # Frost Nova when struck
...
* **Properties:**
    ...
    * +25% Faster Block Rate
    * 35-8% Chance to cast level # Fade when struck
    * Requirements --30%
    * +2 to Random Class Skill Levels
    * +25% Faster Cast Rate
