...
* **Properties:**
    ...
    * Level 1 Holy Fire Aura When Equipped
...
* **Properties:**
    ...
    * Damage Reduced by 6
    * -4-10% to Enemy Poison Resistance
    * +1-2 to Poison Skills
...
* **Properties:**
    ...
    * 35-10% Chance to cast level # Amplify Damage when you Kill an Enemy
...
* **Properties:**
    ...
    * +25% Faster Run/Walk
    * +30% Increased Attack Speed
    * 15-25% Chance to cast level # Amplify Damage on striking
    * +300-400 Defense
...
* **Properties:**
    * +3 to Cold Skills
    * Level 20 Holy Freeze Aura When Equipped
    * +150-200 to Life
    * Cold Resist +66%
    * Cannot Be Frozen
