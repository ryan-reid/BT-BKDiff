...
* **Properties:**
    ...
    * \+1\-2 to Flame Wave \(Warlock only\)
    * \+1\-2 to Ring of Fire \(Warlock only\)
...
* **Properties:**
    ...
    * \+1\-2 to Demonic Mastery \(Warlock only\)
    * \+1\-2 to Blood Boil \(Warlock only\)
    * \+1\-2 to Engorge \(Warlock only\)
    * \+1\-2 to Consume \(Warlock only\)
...
* **Properties:**
    ...
    * \+1\-3 to Psychic Ward \(Warlock only\)
