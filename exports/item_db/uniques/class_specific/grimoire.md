...
* **Properties:**
    ...
    * Fire Resist +10-50%
    * +3-5 to Apocalypse (Class Apocalypse only)
    * +1-2 to Flame Wave (Class Flame Wave only)
    * +1-2 to Ring of Fire (Class Ring of Fire only)
...
* **Properties:**
    ...
    * +1-2 to Consume (Class Consume only)
...
* **Properties:**
    ...
    * +1-3 to Psychic Ward (Class Psychic Ward only)
...
* **Properties:**
    ...
    * +1-3 to Ring of Fire (Class Ring of Fire only)
    * +1-3 to Flame Wave (Class Flame Wave only)
    * +10-20 to Vitality
